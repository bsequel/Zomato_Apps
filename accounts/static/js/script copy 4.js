$(document).ready(function () {
    ...
    function initCaseTable() {
        ...
        // ========================
        // AJAX Helper for Updating Case
        // ========================
        function sendCaseUpdate(caseId, data) {
            $.ajax({
                url: `/cyberapp/cases/${caseId}/update/`,     // Django endpoint
                type: 'POST',
                data: JSON.stringify(data),          // Send body as JSON
                contentType: 'application/json',     // Let DRF parse JSON
        ...
        $(document).on('change', '.status-dropdown', function () {
            ...
            // convert to lowercase because backend expects lowercase values
